...
1. echo -e "\e[32m\n1. Open /data/apache2/conf/httpd.conf and Uncomment Below modules\n\e[0m
...
echo -e "\e[32m\n2. Open /data/apache2/conf/httpd.conf and add "Include conf/extra/etlhive.conf\e[0m"

echo -e "\n\e[32m3. Open /data/apache2/conf/extra/etlhive.conf and  add below -->\n\e[0m
...
echo -e "\n\e[32m4. Execute "/data/apache2/bin/apachectl" to start apache\e[0m"

echo -e "\n\e[32m5. Verify if apache is running 'ps -ef' command\e[0m\n"
